...
<head>
    ...
    <title>Profile | KampusPinjam</title>
                    ...
                    <div class="flex items-center space-x-6 relative">
                        ...
                        <div class="relative">
                            <button id="profileBtn" class="flex items-center focus:outline-none">
                                ...
                                <span class="text-white ml-2">Ryan</span>
                            </button>
            ...
            <div class="flex-1 px-8 pb-8 bg-white flex justify-center items-start">
                <div class="bg-white rounded shadow w-full max-w-xl mt-12 p-8">
                    ...
                    <div class="flex justify-end mt-8">
                        <a href="{{ route('profile.edit') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded font-semibold">Edit Profile</a>
                    </div>
                </div>
            </div>
        </main>
