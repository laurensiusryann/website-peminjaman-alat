                ...
                <div class="bg-white rounded shadow border w-full max-w-3xl mt-12 p-8">
                    ...
                    <form method="POST" action="{{ route('tambah_peminjam.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                <label class="block font-semibold mb-2">Nama User</label>
                                <input type="text" name="name" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400" required>
                            </div>
                            <div>
