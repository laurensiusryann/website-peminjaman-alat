...
<head>
    ...
    <title>Dashboard User | KampusPinjam</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-birutua min-h-screen flex flex-col">
            ...
            <nav class="flex-1 py-4 flex flex-col gap-2">
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('dashboard_user') }}" class="flex items-center px-6 py-3 bg-birutua2 rounded text-white font-semibold border-l-4 border-blue-600">
